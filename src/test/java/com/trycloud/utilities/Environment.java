...
public class Environment {
    ...
    static{
        ...
        String environment = System.getProperty("environment") != null ? environment = System.getProperty("environment") : ConfigReader.getProperty("environment");



        try {
           /* TODO not all team members uses the same exact cimputer so the location for the project is different for every single person. that is why " System.getProperty("user.dir")" make it dynamic"*/
